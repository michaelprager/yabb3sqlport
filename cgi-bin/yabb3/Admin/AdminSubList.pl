...
'database',"Database.pl&SelectDatabase",
'database2',"Database.pl&SaveDatabase",
'database3',"Database.pl&ConvertDatabase",
'database4',"Database.pl&ReturnFileDB",
'database5',"Database.pl&Delete_files",
'database6',"Database.pl&Delete_DB",
