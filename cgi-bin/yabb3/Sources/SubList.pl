...
$sublistplver = 'YaBB 3.0 Beta $Revision: 100 $';
...
'get_cal_ssi',"EventCalSSI.pl&get_cal_ssi",
...
'openidvalidate',"LogInOut.pl&OpenIDValidate",
...
'recent',"Recent.pl&Recent_Topics_Posts",
'recenttopics',"Recent.pl&Recent_Topics_Posts",
